...
import { CryptoTokenHasher } from "../cryptography/crypto-token-hasher.js";
import { PrismaRefreshTokenRepository } from "../database/prisma/repositories/prisma-refresh-token.repository.js";
import { RefreshSessionUseCase } from "@/application/use-cases/auth/refresh-session/refresh-session.use-case.js";
import { LogoutUseCase } from "@/application/use-cases/auth/logout/logout.use-case.js";
...
const generateTokenPair = new GenerateTokenPairService(encrypter, tokenHasher, refreshTokenRepository)
const storageService = new CloudinaryStorageService();

export const createRestaurantOwnerUseCase = new CreateRestaurantOwnerUseCase(ownerRepository, hasher);
export const authenticateRestaurantOwnerUseCase = new AuthenticateRestaurantOwnerUseCase(ownerRepository, hasher, generateTokenPair);
...
export const authenticateCustomerUseCase = new AuthenticateCustomerUseCase(customerRepository, hasher, generateTokenPair);
...
export const refreshSessionUseCase = new RefreshSessionUseCase(refreshTokenRepository, tokenHasher, generateTokenPair);
export const logoutUseCase = new LogoutUseCase(refreshTokenRepository, tokenHasher);
